...
const InstructionsAndFooter = (props) => {
    return (
        <div className="instructionsAndFooter">
            ...
            <div className="howToPlayContiner">
                <label className="howToPlay">
            ...
            <div className="howToPlayNoteContiner">
                <label className="howToPlayNote">
            ...
            <div className="createdByContiner">
                <label className="createdBy">
                    Created by <strong>Gabriele Cirulli.</strong> Based on <strong>1024 by Veewo Studio</strong> and conceptually similar to <strong>Threes by Asher Vollmer.</strong>                </label>
            </div>
...
export default connect(mapStateToProps)(InstructionsAndFooter);
...
//  Donate  Donate BTC1Ec6onfsQmoP9kkL3zkpB6c5sA4PVcXU2i
